...
<div class="modal custom-modal professor-modal" id="resource-modal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="select2-wrapper">
                                    <select id="courses-select" name="course_ids[]" class="form-control select2" multiple>
                                        <option value="Select courses" disabled>Select courses</option>
                                        @foreach ($courses as $course)
                                         <option value="{{ $course->id }}" data-value="{{$course->specialization}}">{{ $course->course_code }} {{ $course->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
