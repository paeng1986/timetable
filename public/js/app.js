var App = {
    Init: function () {
        ...
        $('.professor-modal #specialization').on('change', function () {
            let selectedSpecialization = $(this).val(); 
        
            let $coursesSelect = $('.professor-modal #courses-select');
            $coursesSelect.val(null).trigger('change'); 
        
            $coursesSelect.find('option').each(function () {
                if ($(this).data('value') === selectedSpecialization || !selectedSpecialization) {
